...
const massMeasurement = 'kg'
const lengthMeasurement = 'm'
...
console.log(tyrannosaurus.weight + massMeasurement);

// What was the diet of a velociraptor?
console.log(velociraptor.diet);

// How long was a stegosaurus?
console.log(stegosaurus.length + lengthMeasurement);
...
const populationTotal = populations.reduce((total, amount) => total + amount);
